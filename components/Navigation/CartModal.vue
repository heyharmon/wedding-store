                                    ...
                                    <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                                        <div>
                                            <div class="flex justify-between text-base font-medium text-gray-500">
                                                <p>Subtotal</p>
                                                <p>${{ customerStore.cart.itemsTotal }}</p>
                                            </div>
                                            <p class="mt-0.5 text-sm text-gray-500">This is the total cost your rental items. We only require a 50% deposit to reserve your items.</p>
                                        </div>
                                    </div>

                                    <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                                        <p class="text-base font-medium text-gray-900">Due today:</p>
                                        
                                        <div class="mt-1">
                                            <div class="flex justify-between text-base font-medium text-teal-600">
                                                <p>50% deposit</p>
                                                <p>${{ customerStore.cart.total }}</p>
                                            </div>
                                            <p class="mt-0.5 text-sm text-gray-500">Remaining amount paid week of weding day.</p>
                                        </div>
