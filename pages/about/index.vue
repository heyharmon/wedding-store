  ...
  <main class="isolate">
    ...
    <div class="relative isolate -z-10">
      ...
      <div class="overflow-hidden">
        <div class="mx-auto max-w-7xl px-6 pb-32 pt-16 lg:px-8 lg:pt-10">
          <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              <h1 class="text-4xl font-header tracking-tight text-gray-900 sm:text-6xl">We’re changing the way people connect.</h1>
    ...
    <div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        <h2 class="text-3xl font-header tracking-tight text-gray-900 sm:text-4xl">Our mission</h2>
          ...
          <div class="lg:flex lg:flex-auto lg:justify-center">
            <dl class="w-64 space-y-8 xl:w-80">
              <div v-for="stat in stats" :key="stat.label" class="flex flex-col-reverse gap-y-4">
                ...
                <dd class="text-5xl font-header tracking-tight text-gray-900">{{ stat.value }}</dd>
              </div>
            </dl>
          </div>
        </div>
    ...
    <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-3xl font-header tracking-tight text-gray-900 sm:text-4xl">Our values</h2>
